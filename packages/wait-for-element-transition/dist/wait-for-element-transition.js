/** 
* wait-for-element-transition - v1.0.0.
* git+https://github.com/mkay581/wait-for-element-transition.git
* Copyright 2017 Mark Kennedy. Licensed MIT.
*/

(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.waitForElementTransition = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
exports.default = waitForElementTransition;
...
function getTransitionDuration(el) {
   ...
   */
  var getCssComputedProperty = function getCssComputedProperty(prop) {
    var style = window.getComputedStyle(el);
    return style.getPropertyValue(prop) || el.style[getJsPropName(prop)];
  };

  var delayProp = getCssComputedProperty('transition-delay') || '0ms';
  var durationProp = getCssComputedProperty('transition-duration') || '0ms';
  var times = Array.isArray(durationProp) ? durationProp : [durationProp];
  var delay = Array.isArray(delayProp) ? delayProp : [delayProp];
  var highest = 0;
  var map = void 0;
...
function waitForElementTransition(el) {
  ...
  var duration = getTransitionDuration(el);
  return new Promise(function (resolve) {
    if (duration > 0) {
      setTimeout(resolve.bind(_this, el), duration);
    } else {
      resolve(el);
    }
  });
